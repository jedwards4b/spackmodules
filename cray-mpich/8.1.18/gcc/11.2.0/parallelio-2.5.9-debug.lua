-- -*- lua -*-
-- Module file created by spack (https://github.com/spack/spack) on 2022-10-03 16:21:55.143560
--
-- parallelio@2.5.9%gcc@11.2.0+fortran~ipo+logging+pnetcdf~timing build_type=Debug arch=cray-sles15-zen3/l7sspqx
--
...
prepend_path("CMAKE_PREFIX_PATH", "/glade/work/jedwards/sandboxes/spack/opt/spack/cray-sles15-zen3/gcc-11.2.0/parallelio-2.5.9-l7sspqxdvflavhxfntm6ors4qjuvwcnl/./", ":")
setenv("PIO_VERSION_MAJOR", "2")
setenv("PIO_TYPENAME_VALID_VALUES", "netcdf,pnetcdf,netcdf4p,netcdf4c")
prepend_path("PATH", "/glade/work/jedwards/sandboxes/spack/opt/spack/cray-sles15-zen3/gcc-11.2.0/parallelio-2.5.9-l7sspqxdvflavhxfntm6ors4qjuvwcnl", ":")
